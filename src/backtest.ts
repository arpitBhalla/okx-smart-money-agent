...
- **No Datadash score.** The live product also requires a signal score of ${t.minScore}+; it cannot be rebuilt for the past, so every other rule is applied but not that one.
